    ...
    return (
        <div>
            ...
            <p>
                ...
                have associated with that data. This Privacy Policy for Husky Jeopardy
                is powered by <a href="https://termsfeed.com/">TermsFeed</a>.
            </p>
            ...
            <p>Husky Jeopardy uses the collected data for various purposes:</p>
            <ul>
            ...
            <p>
                Husky Jeopardy will take all steps reasonably necessary to ensure that
            ...
            <p>
                Husky Jeopardy may disclose your Personal Data in the good faith belief
                that such action is necessary to:
            </p>
            <ul>
                <li>To comply with a legal obligation</li>
                <li>To protect and defend the rights or property of Husky Jeopardy</li>
                <li>
